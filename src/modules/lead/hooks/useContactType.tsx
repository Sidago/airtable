...
interface UseContactTypeReturn {
...
export const useContactType = (): UseContactTypeReturn => {
  ...
  const fetchContactTypes = useCallback(async () => {
    ...
    try {
      ...
      const response = await leadService.contactTypeList(token);
  ...
  return useMemo(
    ...
    [options, loading, error, fetchContactTypes]
  );
};
