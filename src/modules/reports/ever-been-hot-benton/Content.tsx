...
const columns: TableColumn<Lead>[] = [
  ...
  { key: "sidago_tobe_called", label: "SVG - To be Called By", width: 130 },
  { key: "benton_lead_type", label: "Benton - Lead Type", width: 130 },
  { key: "benton_tobe_called", label: "Benton - To be Called", width: 130 },
    ...
    <div>
      <Header
        breadcrumbs={[
          ...
          { label: "Ever been Hot - Benton", active: true },
        ]}
