        ...
        <div className="flex flex-col w-full gap-3 md:flex-row md:items-center md:w-auto md:gap-6">
          ...
          <div className="flex items-center gap-2 w-full md:w-auto">
            <Dropdown
              ...
              onChange={(val) =>
                onGroupByChange(typeof val === "string" ? val : null)
              }
            />
              ...
              <HeadlessMenuItems className="outline-0 ring-0 absolute z-50 w-65 rounded-md bg-white shadow-lg right-0 top-10">
                <div className="p-4 flex flex-col gap-1">
                  ...
                  {printAll && (
                    <HeadlessMenuItem
                      as="button"
                      className="flex flex-col px-3 py-2 outline-0 ring-0 hover:bg-gray-100"
                    >
                      <span className="flex items-center gap-2">
                        <Copy size={14} /> Print all leads
                      </span>
                      {/* <span className="text-xs text-gray-500 ml-6">
                        Print lead details for all leads
                      </span> */}
                    </HeadlessMenuItem>
                  )}
                  {csvExport && (
